...
describe( "Test 1", function()
    ...
    setup( function()
        G1 = Automaton.new():IDES_import('models/supervisor/t1/G1.xmd')
        G2 = Automaton.new():IDES_import('models/supervisor/t1/G2.xmd')
        E1 = Automaton.new():IDES_import('models/supervisor/t1/E1.xmd')
        E2 = Automaton.new():IDES_import('models/supervisor/t1/E2.xmd')
        G = Automaton.new():IDES_import('models/supervisor/t1/G.xmd')
        E = Automaton.new():IDES_import('models/supervisor/t1/E.xmd')
        K = Automaton.new():IDES_import('models/supervisor/t1/K.xmd')
        S = Automaton.new():IDES_import('models/supervisor/t1/S.xmd')
    end )
...
describe( "Test 2", function()
    ...
    setup( function()
        G1 = Automaton.new():IDES_import('models/supervisor/t2/G1.xmd')
        G2 = Automaton.new():IDES_import('models/supervisor/t2/G2.xmd')
        G3 = Automaton.new():IDES_import('models/supervisor/t2/G3.xmd')
        G4 = Automaton.new():IDES_import('models/supervisor/t2/G4.xmd')
        E1 = Automaton.new():IDES_import('models/supervisor/t2/E1.xmd')
        E2 = Automaton.new():IDES_import('models/supervisor/t2/E2.xmd')
        E3 = Automaton.new():IDES_import('models/supervisor/t2/E3.xmd')
        E4 = Automaton.new():IDES_import('models/supervisor/t2/E4.xmd')
        E5 = Automaton.new():IDES_import('models/supervisor/t2/E5.xmd')
        E6 = Automaton.new():IDES_import('models/supervisor/t2/E6.xmd')
        E7 = Automaton.new():IDES_import('models/supervisor/t2/E7.xmd')
        G = Automaton.new():IDES_import('models/supervisor/t2/G.xmd')
        E = Automaton.new():IDES_import('models/supervisor/t2/E.xmd')
        K = Automaton.new():IDES_import('models/supervisor/t2/K.xmd')
        S = Automaton.new():IDES_import('models/supervisor/t2/S.xmd')
    end )
