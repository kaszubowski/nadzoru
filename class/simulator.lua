...
local Simulator = {}
local Simulator_MT = { __index = Simulator }
...
function Simulator.new( gui, automaton )
    ...
    self.treeview     = Treeview.new()
        ...
        :bind_ondoubleclick(Simulator.state_change, self)
...
function Simulator.state_change(self, ud_treepath, ud_treeviewcolumn)
...
function Simulator:drawing_area_expose()
...
function Simulator:update_treeview()
...
function Simulator:generate_graphviz( forward_deep )
    local state, node = self:get_current_state()
