...
function Controller:build()
    ...
    self.gui:append_menu_item('automata', "Open", "Open an Automaton"  , 'gtk-new' , self.open_automaton, self)
    ---self.gui:append_menu_item('automata'        , "_Clone Automaton", "Create a Copy of an Automaton", nil, self.clone_automaton, self)
